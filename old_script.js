            ...
            adminAlertBox.innerHTML = `
                ...
                <div>
                    ...
                    <p style="margin: 0; font-size: 0.92rem; color: var(--text-dark); line-height: 1.6;">
                        ?嗅?憭拇除?瘜?憟踝??楝??⊿??br>
                        <span class="badge badge-success" style="font-size:0.75rem; margin-top:4px;">[AI 瘙箇??瑁?]</span> 蝟餌絞蝬剜?璅?摰?疏瘞港? (摰憭拇 7 憭?/ 1.0x 摰摨怠?)??                    </p>
                </div>
            `;
        } else if (mode === 'rainy') {
            ...
            adminAlertBox.innerHTML = `
                ...
                <div>
                    ...
                    <p style="margin: 0; font-size: 0.92rem; color: var(--text-dark); line-height: 1.6;">
                        ...
                        <span class="badge badge-danger" style="font-size:0.75rem; margin-top:4px;">[AI 瘙箇??瑁?]</span> 蝟餌絞撌脰??敺瑟∟撅銋?b>摰?疏憭拇??7 憭抵矽? 10.5 憭?(1.5x)</b>嚗蝭??券?頝臬??颱葉?瑯?                    </p>
                </div>
            `;
        } else if (mode === 'typhoon') {
            ...
            adminAlertBox.innerHTML = `
                ...
                <div>
                    ...
                    <p style="margin: 0; font-size: 0.92rem; color: var(--text-dark); line-height: 1.6;">
                        ...
                        <span class="badge badge-danger" style="font-size:0.75rem; margin-top:4px;">[AI 瘙箇??瑁?]</span> 蝟餌絞撌脰???典????寧???<b>摰?脣?憭拇隤踹???14 憭?(2.0x)</b>嚗?瘙之皞芣??西撅?瑁???批之摰矽?乓?                    </p>
                </div>
            `;
        }
    }
...
async function fetchSystemData() {
    try {
        ...
        console.warn("?? ??? mock_nhi_data.json 憭望?嚗?刻??園? fallback 頛?豢?嚗?);
        let localInv = localStorage.getItem('SmartPharma_Inventory');
        if (localInv) {
            dbInventory = JSON.parse(localInv);
        } else {
            dbInventory = [
                { drugCode: 'A059591100', drugChineseName: '??????(Tamiflu) - 瘚??刻', drugEnglishName: 'Tamiflu Capsules 75mg', price: 950, rxOnly: true, atcCode: 'J05AH02', dosageForm: '????, singleCompoundFlag: '?格', manufacturer: 'Roche', temperatureReq: 'Room', expiryDays: 180, batchNo: 'B82103', stock_DEYI: 12, stock_FUXING_HC: 18, stock_KAO_CLINIC: 4, stock_SHISHENG_FX: 60, stock_GREAT_TREE: 80, stock_SHISHENG_KZ: 45, stock_ZISHENG: 35 },
                { drugCode: 'B023245100', drugChineseName: '?格?潭迫?? (Panadol) - ??迫??, drugEnglishName: 'Panadol 500mg', price: 15, rxOnly: false, atcCode: 'N02BE01', dosageForm: '??', singleCompoundFlag: '?格', manufacturer: 'GSK', temperatureReq: 'Room', expiryDays: -5, expiryDate: '2026-05-30', batchNo: 'B22938', stock_DEYI: 40, stock_FUXING_HC: 30, stock_KAO_CLINIC: 15, stock_SHISHENG_FX: 100, stock_GREAT_TREE: 120, stock_SHISHENG_KZ: 80, stock_ZISHENG: 60 },
                { drugCode: 'B023245199', drugChineseName: '撣??祆迫????(Ibuprofen) - ?訾撮?蹂誨??, drugEnglishName: 'Ibuprofen 400mg', price: 20, rxOnly: false, atcCode: 'N02BE99', dosageForm: '????, singleCompoundFlag: '?格', manufacturer: 'AstraZeneca', temperatureReq: 'Room', expiryDays: 190, batchNo: 'B33842', stock_DEYI: 25, stock_FUXING_HC: 20, stock_KAO_CLINIC: 10, stock_SHISHENG_FX: 90, stock_GREAT_TREE: 100, stock_SHISHENG_KZ: 70, stock_ZISHENG: 50 },
                { drugCode: 'I012345678', drugChineseName: '?啣雀蝝釣撠? (Insulin) - 蝟倏?蝞?, drugEnglishName: 'Novomix 30 Flexpen', price: 800, rxOnly: true, atcCode: 'A10AD05', dosageForm: '瘜典???, singleCompoundFlag: '銴', manufacturer: 'Novo Nordisk', temperatureReq: 'Cold Chain 2-8簞C', expiryDays: 25, expiryDate: '2026-06-30', batchNo: 'B90234', stock_DEYI: 3, stock_FUXING_HC: 2, stock_KAO_CLINIC: 1, stock_SHISHENG_FX: 45, stock_GREAT_TREE: 60, stock_SHISHENG_KZ: 30, stock_ZISHENG: 25 },
                { drugCode: 'I012345699', drugChineseName: '蝢撟喟??拚? (Metformin) - 蝟倏?隡潭隞?', drugEnglishName: 'Metformin 500mg', price: 10, rxOnly: true, atcCode: 'A10BA02', dosageForm: '??', singleCompoundFlag: '?格', manufacturer: 'Sandoz', temperatureReq: 'Room', expiryDays: 85, expiryDate: '2026-08-30', batchNo: 'B78129', stock_DEYI: 8, stock_FUXING_HC: 10, stock_KAO_CLINIC: 5, stock_SHISHENG_FX: 100, stock_GREAT_TREE: 80, stock_SHISHENG_KZ: 60, stock_ZISHENG: 40 },
                { drugCode: 'E060800100', drugChineseName: '??蝬?(Paxlovid) - COVID-19撠??, drugEnglishName: 'Paxlovid Film-Coated', price: 20000, rxOnly: true, atcCode: 'J05AE30', dosageForm: '?﹝??', singleCompoundFlag: '銴', manufacturer: 'Pfizer', temperatureReq: 'Room', expiryDays: 90, batchNo: 'B11234', stock_DEYI: 5, stock_SHISHENG_FX: 20, stock_GREAT_TREE: 30, stock_SHISHENG_KZ: 15, stock_ZISHENG: 10 },
                ...
                <div style="display: flex; align-items: center; gap: 12px; flex: 1; min-width: 0;">
                    ...
                    <div style="min-width: 0;">
                        ...
                        <div style="font-size: 0.8rem; color: var(--text-muted); margin-top: 4px;">
                            ${meta.district} | ?拚?摨怠?: <strong style="color: ${currentStock > 0 ? 'var(--secondary-color)' : 'var(--danger-color)'}; font-weight: 800;">${currentStock}</strong> ??                        </div>
                    </div>
                </div>
        ...
        if (req.status === '撌脫?摨?) {
            ...
            actionHtml = `
                <button class="btn btn-success" style="width:100%; margin-top:12px;" onclick="apiDriverArrive('${req.id}')">
                    <i class="fa-solid fa-map-location-dot"></i> 蝣箄??菟?蝯?銝阡??嗥偷??                </button>
            `;
        }
